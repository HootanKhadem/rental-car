...
export default function LanguageSwitcher() {
  ...
  return (
    <Button
      ...
      className="rounded-full border border-line text-sand hover:bg-transparent hover:text-gold hover:border-gold text-xs px-3 py-2 gap-1"
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <g clipPath="url(#clip0_4418_7015)">
          <path
            d="M12 22.75C6.07 22.75 1.25 17.93 1.25 12C1.25 6.07 6.07 1.25 12 1.25C17.93 1.25 22.75 6.07 22.75 12C22.75 17.93 17.93 22.75 12 22.75ZM12 2.75C6.9 2.75 2.75 6.9 2.75 12C2.75 17.1 6.9 21.25 12 21.25C17.1 21.25 21.25 17.1 21.25 12C21.25 6.9 17.1 2.75 12 2.75Z"
            style={{
              fill: isHover ? "var(--color-gold, #FFD54A)" : "currentColor",
            }}
          />
          <path
