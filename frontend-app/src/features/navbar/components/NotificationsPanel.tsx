...
export default function NotificationsPanel({
  ...
  return (
    <Popover
      trigger={
        <Button
          id="rc-notifications-trigger"
          aria-label={t("notifications.title")}
          className="p-2.5 bg-transparent text-smoke rounded-lg border border-line flex items-center justify-center cursor-pointer hover:text-gold hover:border-gold hover:bg-transparent"
        >
          <span className="relative">
            ...
            <span className="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-red-500 border-2 border-background-main" />
          </span>
        </Button>
      }
      side="bottom"
              ...
              return (
                ...
                "
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-semibold text-ivory">{titleText}</div>
