    ...
    <div className="min-h-screen bg-ink py-12">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-10 mt-20">
          <p className="text-sm text-gold font-mono tracking-[2px] mb-3">
            {mounted ? t("catalog.badge") : "THE COLLECTION"}
          </p>
          <h1 className="text-5xl font-serif text-ivory">
        ...
        {/* Stats */}
        <div className="mb-6 text-sm text-smoke font-mono">
          {mounted
            ? t("catalog.showing", {
                count: filtered.length,
                total: MOCK_CARS.length,
              })
            : `Showing ${filtered.length} of ${MOCK_CARS.length} vehicles`}
        </div>
        ...
        {/* Empty State */}
        {filtered.length === 0 && (
          <div className="text-center py-20 bg-obsidian rounded-xl border border-line">
            <p className="text-ivory text-lg mb-2">No vehicles found</p>
